 ...
 <div class="container-center">
	<div class="container-login100" style="background-image: url('/resources/login/images/bg-01.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form id="changePwd" action="" method="post" class="login100-form validate-form">
				...
				<div class="wrap-input100 validate-input m-b-25" data-validate = "새로운 비밀번호를 다시 입력하세요">
					<input class="input100" type="password" name="new_password" id="new_password" placeholder="새로운 비밀번호를 입력하세요" value="${vo.new_password}">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 validate-input m-b-25" data-validate = "새로운 비밀번호를 다시 입력하세요">
					<input class="input100" type="password" name="confirm_password" id="confirm_password" placeholder="새로운 비밀번호를 다시 입력하세요">
					<span class="focus-input100"></span>
				</div> 
				
				<!-- <div class="container-login100-form-btn"> -->
				<div class="p-r-70  p-t-10" >
					<button type ="submit" class="login100-form-btn btn-change" >
						변경
					</button>
